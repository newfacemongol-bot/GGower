    ...
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-slate-100 p-6">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-600">30 пэйж, 400+ boost зар, 24/7 автомат систем</p>
        </div>
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-sm text-slate-600">ERP, пэйж, тохиргоо удирдах</p>
          </Link>
          <Link
            href="/operator/login"
            className="group bg-white rounded-xl border border-slate-200 p-8 hover:border-slate-900 hover:shadow-lg transition-all"
          >
            ...
            <p className="text-sm text-slate-600">Live chat, захиалгын дэмжлэг</p>
          </Link>
        </div>
      </div>
    </main>
