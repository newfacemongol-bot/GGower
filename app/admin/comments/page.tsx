  ...
  return (
    <div className="p-8 max-w-6xl">
      ...
      <div className="flex flex-wrap gap-3 mb-4">
        ...
        <input value={phone} onChange={(e) => setPhone(e.target.value)} placeholder="Утас..." className="px-3 py-2 border border-slate-300 rounded-lg text-sm" />
        ...
        <button onClick={() => { setPage(1); load(); }} className="px-4 py-2 bg-slate-900 text-white text-sm rounded-lg">Шүүх</button>
        <button
        ...
        >
          <Archive className="w-4 h-4" /> Архив харах
        </button>
      </div>
          ...
          <div key={c.id} className="p-4 flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <div className="text-xs text-slate-500 mt-1 flex gap-3 flex-wrap">
                ...
                {c.isArchived && <span className="text-slate-400">Архивлагдсан</span>}
              </div>
            </div>
